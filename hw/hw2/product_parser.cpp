...
Product* ProductBookParser::makeProduct() {
    // makes new book
    Book* new_book = new Book(categoryID(), prodName_, price_, qty_, author_, isbn_);
    return new_book;
}
...
Product* ProductClothingParser::makeProduct() {
    // creates new clothing
    Clothing* new_clothing = new Clothing(categoryID(), prodName_, price_, qty_, brand_, size_);
    return new_clothing;
}
...
Product* ProductMovieParser::makeProduct() {
    // creates new movie
    Movie* new_movie = new Movie(categoryID(), prodName_, price_, qty_, rating_, genre_);
    return new_movie;
}
